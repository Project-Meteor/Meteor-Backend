...
3) To add more gameservers you will have to do it like this `"gameServerIP": ["162.43.31.222:7777:playlist_defaultsolo", "162.43.31.222:7777:playlist_defaultduo"],`
...
class Handlers
{
    static function OnBeforeRequest(oSession: Session) {
        ...
        if (oSession.PathAndQuery.Contains("/caldera/api/v1/launcher/racp"))
        {
            ...
            oSession.fullUrl = "http://162.43.31.222:5000" + oSession.PathAndQuery
        }
        if (oSession.hostname.Contains("epicgames"))
        {
            ...
            oSession.fullUrl = "http://162.43.31.222:3551" + oSession.PathAndQuery
        }
    }
}
```

if u change **Caldera Service port** modify this string on **fiddler script**: `oSession.fullUrl = "http://162.43.31.222:urport" + oSession.PathAndQuery`
if u change **Backend port** modify this string on **fiddler script**: `oSession.fullUrl = "http://162.43.31.222:urport" + oSession.PathAndQuery`
